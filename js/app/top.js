...
var Top = React.createClass({
	...
	tapsubmit:function(){
		var un = this.refs.unname.value;
		if(this.refs.yanzheng.value != this.state.res2 ){
			alert("验证码错误")
		}else if(un.trim() != ""){
				    	...
				    	<div className="modal-content" style={{"min-height":"550px"}}>
					        ...
					        <div className="modal-body">
						        ...
						        <div style={sty.logindiv} className="form-group">
						        	<input style={{"text-align":"center"}} type="email" className="form-control" id="exampleInputEmail1" placeholder="Username" ref="unname"/>
						        </div>
						        <div style={sty.logindiv} className="form-group">
					        ...
					        <div className="modal-footer">
					        	...
					        	<button type="submit" className="btn btn-primary" onClick={this.tapsubmit}>登录</button>
					        </div>
				        	</form>
